...
const allUpperCase = (arr) => {
  ...
  let addedArr = [];
  arr.forEach(element => {
    addedArr.push(element.toUpperCase());
  });
  return addedArr;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(element => {
    addedArr.push(callback(element));
  }
  );
  return addedArr;
};
...
const createList = (availableItems) => {
  ...
  availableItems.forEach(element => {
    (element.available) ? addedArr.push(element.name) : element.name;
  });
  return addedArr;
};
...
const fizzbuzz = (arr) => {
  ...
  let addedArr = [];
  arr.forEach(element => {
    (element % 3 === 0 && element % 5 === 0 ) ? addedArr.push('Fizz Buzz') :
      (element % 3 === 0) ? addedArr.push('Fizz') :
        (element % 5 === 0) ? addedArr.push('Buzz') :
          addedArr.push(element);
  }
  );
  return addedArr;
